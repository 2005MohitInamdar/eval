...
export const routes: Routes = [
    ...
    {path: "welcome", component: SplashScreen, title: "Tutorials page"},      
      ...
      },
      {
        ...
        loadComponent: () => import('./components/authentication/auth_functions/wait/wait').then(m => m.Wait)
      },
      // app.routes.ts
    ...
    },
    {
      ...
      title: "Interview Details Page",
      canActivate: [authGuard], 
      loadComponent: () => import('./components/interview-details/interview-details').then(m => m.InterviewDetails),
    },
    {
        path: "ui_wrapper",
